...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_siswa.php?nisn=<?php echo base64_encode($Get['nisn']) ?>"><img src="view.png" width="17"></a>
                    <button onclick="konfirmasi('<?php echo base64_encode($Get['nisn']) ?>')">Delete</button>
            </tr>
    <?php
        }
    }
