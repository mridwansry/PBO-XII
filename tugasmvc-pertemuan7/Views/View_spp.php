...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_spp.php?id_spp=<?php echo base64_encode($Get['id_spp']) ?>"><img src="view.png" width="17"></a>
                    <button onclick="konfirmasi('<?php echo base64_encode($Get['id_spp']) ?>')">Delete</button>
                </td>
            </tr>
    <?php
        }
