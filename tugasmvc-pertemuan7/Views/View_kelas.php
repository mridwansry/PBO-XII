...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_kelas.php?id_kelas=<?php echo base64_encode($Get['id_kelas']) ?>"><img src="view.png" width="17"></a>
                    <button onclick="konfirmasi('<?php echo base64_encode($Get['id_kelas']) ?>')">Delete</button>
                </td>
            </tr>
    <?php
        }
