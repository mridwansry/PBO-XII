...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Agu 2021 pada 07.59
...
CREATE TABLE `kelas` (
  ...
  `id_join` int(11) NOT NULL DEFAULT 1
...
INSERT INTO `kelas` (`id_kelas`, `nama_kelas`, `kompetensi_keahlian`, `id_join`) VALUES
(1, 'XII-RPL 2', 'REKAYASA PERANGKAT LUNAK', 1),
(2, 'XII-TFLM 2', 'TEKNIK FABRIKASI LOGAM DAN MANUFAKTUR', 1),
(3, 'XII-TKJ 1', 'TEKNIK KOMPUTER DAN JARINGAN', 1);
...
INSERT INTO `spp` (`id_spp`, `tahun`, `nominal`, `id_join`) VALUES
(1, 2021, 30000, 1),
(2, 2022, 25000, 1),
(3, 2023, 20000, 1),
(4, 2024, 15000, 1);
