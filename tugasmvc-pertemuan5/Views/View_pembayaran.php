            ...
            <?php
                ...
                if(isset($GetPembayaran))
                {
                        ...
                        <tr>
                            ...
                            <td>
                                <button href="../Views/View_put_pembayaran.php?id_pembayaran=<?php echo $Get['id_pembayaran'] ?>">view</button>
                                <button onclick="return konfirmasi(<?php echo $Get['id_pembayaran'] ?>)">Delete</button>
                            </td>
                        </tr>
                        <?php 
                        }
