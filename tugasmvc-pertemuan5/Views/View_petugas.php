            ...
            <?php
                ...
                if(isset($GetPetugas))
                {
                        ...
                        <tr>
                            ...
                            <td>
                                <button href="../Views/View_put_petugas.php?id_petugas=<?php echo $Get['id_petugas'] ?>">view</button>
                                <button onclick="return konfirmasi(<?php echo $Get['id_petugas'] ?>)">Delete</button>
                            </td>
                        </tr>
                        <?php 
                        }
